...
<button type="button" class="disclaimer--site-default__close" id="site-disclaimer-close" aria-label="${esc(t.site_disclaimer_close_aria)}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6 6L18 18M6 18L18 6"/></svg></button>
</div>
</aside>
...
const DISCLAIMER_JS = `(function(){
  ...
  function syncHeight(){
    var visible=el.getAttribute('data-state')==='visible';
    root.style.setProperty('--disclaimer-height',(visible?el.offsetHeight:0)+'px');
  }
  try{if(window.localStorage&&localStorage.getItem(KEY)==='1'){el.setAttribute('data-state','hidden');root.style.setProperty('--disclaimer-height','0px');return;}}catch(e){}
