...
window.SITE_CONTENT = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs_nl: [
        "Alcohol werkt voornamelijk op het GABA-A-systeem en op het glutamaat-NMDA-systeem; klinisch is het een centraal-zenuwstelsel-depressant. Psilocybine wordt in het lichaam snel omgezet naar psilocine, dat als partiële agonist werkt op de 5-HT2A-receptor. Deze farmacologische routes overlappen weinig (<a href=\"https://doi.org/10.1177/0269881117725915\">Carhart-Harris en Nutt, 2017</a>; <a href=\"https://doi.org/10.1124/pr.115.011478\">Nichols, 2016</a>). Dat verklaart waarom er geen acuut serotonine-emergiemechanisme bekend is bij deze combinatie, anders dan bij de combinatie met MAO-remmers.",
        "Wat de combinatie wél doet, op basis van klinische extrapolatie en harm-reduction-rapportages: alcohol kan het psychedelische effect deels dempen of vervlakken, terwijl misselijkheid, duizeligheid en het risico op black-outs juist toenemen. Voor de duidelijkheid: er is geen gepubliceerde gecontroleerde humane co-administratiestudie van psilocybine met alcohol. Het mechanisme is helder, het klinische beeld komt uit <a href=\"https://www.drugsinfo.nl/\">Trimbos</a>, <a href=\"https://www.jellinek.nl/vraag-en-antwoord/\">Jellinek</a>, <a href=\"https://unity.nl/\">Unity</a> en <a href=\"https://dancesafe.org/\">DanceSafe</a>, en uit klinische extrapolatie."
      ],
      paragraphs_en: [
        "Alcohol works mainly on the GABA-A system and the glutamate-NMDA system; clinically it's a central nervous system depressant. Psilocybin gets converted in the body quickly to psilocin, which acts as a partial agonist at the 5-HT2A receptor. These pharmacological pathways barely overlap (<a href=\"https://doi.org/10.1177/0269881117725915\">Carhart-Harris and Nutt, 2017</a>; <a href=\"https://doi.org/10.1124/pr.115.011478\">Nichols, 2016</a>). That explains why no acute serotonin-emergency mechanism is known for this combination, unlike the combination with MAO inhibitors.",
        "What the combination does do, based on clinical extrapolation and harm-reduction reports: alcohol can partly dampen or flatten the psychedelic effect, while nausea, dizziness, and the risk of black-outs go up. To be clear: there's no published controlled human co-administration study of psilocybin with alcohol. The mechanism is clear, the clinical picture comes from <a href=\"https://www.drugsinfo.nl/\">Trimbos</a>, <a href=\"https://www.jellinek.nl/vraag-en-antwoord/\">Jellinek</a>, <a href=\"https://unity.nl/\">Unity</a>, and <a href=\"https://dancesafe.org/\">DanceSafe</a>, and from clinical extrapolation."
      ]
    },
    {
    ...
    },
    {
      ...
      paragraphs_nl: [
        "THC bindt voornamelijk aan de cannabinoïd-receptor CB1. Tussen CB1 en 5-HT2A bestaan in proefdieronderzoek heteromere receptorcomplexen waarvan de signaaltransductie verandert wanneer beide receptoren tegelijk geactiveerd worden (<a href=\"https://doi.org/10.1371/journal.pbio.1002194\">Viñals et al., 2015</a>). Bij chronische cannabisgebruikers is die heteromer-expressie zelfs verhoogd in menselijke olfactorische cellen ex vivo (<a href=\"https://doi.org/10.3389/fphar.2018.01059\">Galindo et al., 2018</a>). In gewone taal: THC en psilocine tellen niet eenvoudigweg op alsof ze op dezelfde receptor zitten. Hun gezamenlijke aanwezigheid verandert het signaalprofiel op een complexe, niet-lineaire manier.",
        "In de praktijk beschrijven gebruikers en de <a href=\"https://doi.org/10.1177/02698811231209194\">Wolinsky, Barrett en Vandrey 2024 review</a> consistent dat een joint tijdens een psilocybinetrip de psychedelische component versterkt en verlengt. Een gecontroleerde humane co-administratiestudie ontbreekt, dus de exacte effectmaten zijn niet vast te stellen; de richting is wel duidelijk."
      ],
      paragraphs_en: [
        "THC binds primarily to the cannabinoid receptor CB1. Between CB1 and 5-HT2A, animal studies have found heteromeric receptor complexes whose signal transduction changes when both receptors are activated together (<a href=\"https://doi.org/10.1371/journal.pbio.1002194\">Viñals et al., 2015</a>). In chronic cannabis users this heteromer expression is even elevated in human olfactory cells ex vivo (<a href=\"https://doi.org/10.3389/fphar.2018.01059\">Galindo et al., 2018</a>). In plain language: THC and psilocin don't simply add up as if they sat on the same receptor. Their joint presence shifts the signal profile in a complex, non-linear way.",
        "In practice, users and the <a href=\"https://doi.org/10.1177/02698811231209194\">Wolinsky, Barrett and Vandrey 2024 review</a> consistently describe that a joint during a psilocybin trip intensifies and prolongs the psychedelic component. A controlled human co-administration study is missing, so exact effect sizes can't be pinned down; the direction is clear."
      ]
    },
    {
      ...
      paragraphs_en: [
        "Cannabis demonstrably raises paranoid symptoms compared with placebo, with a stronger effect for THC-rich products than for CBD-rich products or THC-CBD blends (<a href=\"https://www.sciencedirect.com/science/article/pii/S0149763425002702\">Petrilli et al., 2025, meta-analysis</a>). The <a href=\"https://doi.org/10.1093/schbul/sbu098\">Freeman 2015 RCT</a> with intravenous THC showed that THC significantly increases anxiety, negative cognitions, and paranoia, and reduces working memory.",
    ...
    },
    {
      ...
      paragraphs_nl: [
        "Niet alle cannabis is hetzelfde. THC produceert het bekende intoxicerende effect en is dosis-afhankelijk geassocieerd met angst en paranoia. CBD, geïsoleerd of in CBD-rijke variëteiten, heeft geen overlappend intoxicerend profiel. In cross-over RCT's is CBD geassocieerd met een afname van paranoia en angst tegenover pure THC (<a href=\"https://doi.org/10.1038/s41386-022-01478-z\">Englund et al., 2023</a>). Functionele neuro-imaging laat zien dat THC en CBD op meerdere hersengebieden tegengestelde effecten hebben (<a href=\"https://doi.org/10.1001/archgenpsychiatry.2009.197\">Bhattacharyya, 2010</a>; <a href=\"https://doi.org/10.1177/0269881119841569\">Wall, 2019</a>).",
    ...
    },
    {
      ...
      paragraphs_nl: [
        ...
        "3. Holze F, Ley L, Müller F, et al. (2022). Direct comparison of the acute effects of lysergic acid diethylamide and psilocybin in a double-blind placebo-controlled study in healthy subjects. Neuropsychopharmacology 47(6): 1180-1187. DOI: 10.1038/s41386-022-01297-2",
        "4. Nichols DE (2016). Psychedelics. Pharmacological Reviews 68(2): 264-355. DOI: 10.1124/pr.115.011478",
        "5. Wolinsky D, Barrett FS, Vandrey R (2024). The psychedelic effects of cannabis: A review of the literature. Journal of Psychopharmacology 38(1): 49-55. DOI: 10.1177/02698811231209194",
